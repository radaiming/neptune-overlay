...
# $Id$
# Copied from portage. It's not easy to update ffmpeg to 9999, so
# I make it a little more static to let multiple versions co-exist
...
multilib_src_install() {
	newbin ffmpeg ffmpeg-static
	newbin ffprobe ffprobe-static
}
